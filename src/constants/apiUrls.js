export const API_URLS = {
  ...
  resources: {
    ...
    visaRequirementsUpdate: (requirementId) => `/admin/visa/requirements/update/${requirementId}`,
    visaRequirementById: (requirementId) => `/admin/visa/requirements/${requirementId}`,
